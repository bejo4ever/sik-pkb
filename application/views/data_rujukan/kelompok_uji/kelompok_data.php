                    ...
                    <div class="main-content" style="min-height:500px">
						...
						<?php if($display!="hidden"){ ?>
                            <!--ul class="action-buttons clearfix">
                                <li><a href="#" class="button" data-icon-primary="ui-icon-plusthick">Tambah Kelompok Uji</a></li>
                            </ul-->
						<?php } ?>
                            <h2>
                               Daftar Kelompok Uji
                                ...
                                <table class="display">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="ui-state-default">Klasifikasi</th>
											<th class="ui-state-default">Deskripsi Kelompok</th>
											<?php if($display!="hidden"){ ?>
