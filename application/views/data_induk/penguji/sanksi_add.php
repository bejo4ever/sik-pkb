...
<body style="overflow: hidden;">
          ...
          <form class="form has-validation" id="formAdd" action="<?=base_url()?>index.php/penguji/sanksi_save" method="post">
			...
			<input type="hidden" style="width:190px" id="nip" name="nrp" required="required" value="<?= $nrp; ?>"/>
			...
			<div class="form-action clearfix" align="right" style="padding-right:10px">
					...
					<button class="button" type="button" onClick="$('#addSanksi' ).dialog('close');">Batalkan</button>
				</div>
		</form>
