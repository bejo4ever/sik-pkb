					...
					<div class="clearfix">
						<div  style="min-height:255px">
							<div>
								...
								<?php $tData=count($this->prapengujianmodel->getHasilUjiFisik($no_daftar,'111','hasil')); ?>
								<input type="hidden" name="tData" value="<?=$tData?>">			
								<input type="hidden" name="no_uji" value="<?=$no_uji?>">
								<input type="hidden" name="no_daftar" value="<?=$no_daftar?>">
								...
								<table width="100%">
									<tr>
										...
										<td width="25%" align="center">
											<?php
												$h1=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'111','hasil');
										...
										<td rowspan="2" align="center" width="17%">
											<?php
												$penguji1=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'112','penguji');
											?> 
									...
									<tr>
										...
										<td align="center">
											<?php
												$h2=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'112','hasil');
								...
								<table width="100%">
									<tr>
										...
										<td width="25%" align="center">
											<?php
												$h3=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'211','hasil');
										...
										<td rowspan="4" align="center" width="17%">
											<?php
												$penguji2=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'211','penguji');
											?>  
									...
									<tr>
										...
										<td align="center">
											<?php
												$h4=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'212','hasil');
									...
									<tr>
										...
										<td align="center">
											<?php
												$h5=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'213','hasil');
									...
									<tr>
										...
										<td align="center">
											<?php
												$h6=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'214','hasil');
								...
								<table width="100%">
									<tr>
										...
										<td width="25%" align="center">
											<?php
												$h7=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'311','hasil');
										...
										<td rowspan="3" align="center" width="17%"> 
											<?php
												$penguji3=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'311','penguji');
											?> 
									...
									<tr>
										...
										<td align="center">
											<?php
												$h8=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'312','hasil');
									...
									<tr>
										...
										<td align="center">
											<?php
												$h9=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'313','hasil');
								...
								<table width="100%">
									<tr>
										...
										<td width="25%" align="center">
											<?php
												$h10=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'411','hasil');
										...
										<td rowspan="6" align="center" width="17%">
											<?php
												$penguji4=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'411','penguji');
											?>  
									...
									<tr>
										...
										<td align="center">
											<?php
												$h11=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'412','hasil');
									...
									<tr>
										...
										<td align="center">
											<?php
												$h12=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'413','hasil');
									...
									<tr>
										...
										<td align="center">
											<?php
												$h13=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'414','hasil');
									...
									<tr>
										...
										<td align="center">
											<?php
												$h14=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'415','hasil');
									...
									<tr>
										...
										<td align="center">
											<?php
												$h15=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'416','hasil');
								...
								<table width="100%">
									...
									<tr>
										...
										<td width="25%" align="center">
											<?php
												$h16=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'511','hasil');
										...
										<td rowspan="21" align="center" width="17%"> 
											<?php
												$penguji5=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'511','penguji');
											?>
									...
									<tr>
										...
										<td align="center">
											<?php
												$h17=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'512','hasil');
									...
									<tr>
										...
										<td align="center">
											<?php
												$h18=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'513','hasil');
									...
									<tr>
										...
										<td align="center">
											<?php
												$h19=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'514','hasil');
									...
									<tr>
										...
										<td align="center">
											<?php
												$h20=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'515','hasil');
									...
									<tr>
										...
										<td align="center">
											<?php
												$h21=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'521','hasil');
									...
									<tr>
										...
										<td align="center">
											<?php
												$h22=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'522','hasil');
									...
									<tr>
										...
										<td align="center">
											<?php
												$h23=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'523','hasil');
									...
									<tr>
										...
										<td align="center">
											<?php
												$h24=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'531','hasil');
									...
									<tr>
										...
										<td align="center">
											<?php
												$h25=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'532','hasil');
									...
									<tr>
										...
										<td align="center">
											<?php
												$h26=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'533','hasil');
									...
									<tr>
										...
										<td align="center">
											<?php
												$h27=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'541','hasil');
									...
									<tr>
										...
										<td align="center">
										<?php
											$h28=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'542','hasil');
									...
									<tr>
										...
										<td align="center">
											<?php
												$h29=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'543','hasil');
									...
									<tr>
										...
										<td align="center">
											<?php
												$h30=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'544','hasil');
									...
									<tr>
										...
										<td align="center">
											<?php
												$h31=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'545','hasil');
									...
									<tr>
										...
										<td align="center">
											<?php
												$h32=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'546','hasil');
								...
								<table width="100%">
									<tr>
										...
										<td width="25%" align="center">
											<?php
												$h33=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'611','hasil');
										...
										<td rowspan="8" align="center" width="17%">
											<?php
												$penguji6=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'611','penguji');
											?> 
									...
									<tr>
										...
										<td align="center">
											<?php
												$h34=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'612','hasil');
									...
									<tr>
										...
										<td align="center">
											<?php
												$h35=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'613','hasil');
									...
									<tr>
										...
										<td align="center">
											<?php
												$h36=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'614','hasil');
									...
									<tr>
										...
										<td align="center">
											<?php
												$h37=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'615','hasil');
									...
									<tr>
										...
										<td align="center">
											<?php
												$h38=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'616','hasil');
									...
									<tr>
										...
										<td align="center">
											<?php
												$h39=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'617','hasil');
									...
									<tr>
										...
										<td align="center">
											<?php
												$h40=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'618','hasil');
					...
					<div class="clearfix">
                    	<div style="min-height:255px">
							<div class="grid_6  clearfix">
								<form class="form has-validation" action="#" method="post">
								<?php $tData=count($this->prapengujianmodel->getHasilUjiFisik($no_daftar,'711')); ?>
								<input type="hidden" name="tData" value="<?=$tData?>">			
								<input type="hidden" name="no_uji" value="<?=$no_uji?>">
								<input type="hidden" name="no_daftar" value="<?=$no_daftar?>">
								<fieldset style="margin:10px 0 0 5px;">
								...
								<table width="100%">
									<tr>
										...
										<td align="right" width="25%"><input type="text" name="711"  style="width:50px" value="<?=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'711')?>" readonly="true" > dBA &nbsp;</td>
										<td width="17%" align="center"> 
											<?php
												$penguji1=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'711','penguji');
											?> 
											<select name="penguji_7" disabled>
											<option value="">Pilih Penguji</option>
											<?php foreach($penguji as $p): ?> 
												<option value="<?=$p->nip_penguji?>" <?php echo (($penguji1==$p->NRP) ? 'selected':'') ; ?> ><?=$p->nama_penguji?></option>
											<?php endforeach; ?>
											</select>
										</td>
									</tr>
								...
								<table width="100%">
									<tr>
										...
										<td rowspan="2" width="17%" align="center">
											...
											<option value="">Pilih Penguji</option>
											<?php foreach($penguji as $p): ?> 
											<?php if($penguji2==$p->NRP){ $p2="selected"; }else{ $p2=""; } ?>
												<option value="<?=$p->nip_penguji?>" <?=$p2?> ><?=$p->nama_penguji?></option>
												<?php endforeach; ?>
											</select>
										</td>
									...
									<tr>
										...
										<td align="right">
											CO = <input type="text" name="821" style="width:50px" value="<?=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'821')?>" readonly="true" > %&nbsp;&nbsp; <br>
											HCL = <input type="text" name="822" style="width:50px" value="<?=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'822')?>" readonly="true" > Ppm
										</td>
									</tr>
								</table>
								</div>
								...
								<table width="100%">
									<tr height="30px">
										...
										<td width="25%" align="right">
											<?php
												$h1=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'911','hasil');
												if($h1=="L"){ $v11="checked"; }else{ $v12="checked"; }
											?>
										...
										<td rowspan="7" width="17%" align="center">
											<?php
												$penguji3=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'911','penguji');
											?> 
											<select name="penguji_9" disabled>
											<option value="">Pilih Penguji</option>
												<?php foreach($penguji as $p): ?> 
												<?php if($penguji3==$p->NRP){ $p3="selected"; }else{ $p3=""; } ?>
												<option value="<?=$p->nip_penguji?>" <?=$p3?> ><?=$p->nama_penguji?></option>
												<?php endforeach; ?>
											</select>
										</td>
									...
									<tr height="30px">
										...
										<td align="right">
											<?php
												$h2=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'912','hasil');
												if($h2=="L"){ $v21="checked"; }else{ $v22="checked"; }
											?>
									...
									<tr height="30px">
										...
										<td align="right">
											<?php
												$h3=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'913','hasil');
												if($h3=="L"){ $v31="checked"; }else{ $v32="checked"; }
											?>
									...
									<tr height="30px">
										...
										<td align="right">
											<?php
												$h4=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'914','hasil');
												if($h4=="L"){ $v41="checked"; }else{ $v42="checked"; }
											?>
									...
									<tr height="30px">
										...
										<td align="right">
											<?php
												$h5=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'915','hasil');
												if($h5=="L"){ $v51="checked"; }else{ $v52="checked"; }
											?>
									...
									<tr height="30px">
										...
										<td align="right">
											<?php
												$h6=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'916','hasil');
												if($h6=="L"){ $v61="checked"; }else{ $v62="checked"; }
											?>
									...
									<tr height="30px">
										...
										<td align="right">
											<?php
												$h7=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'917','hasil');
												if($h7=="L"){ $v71="checked"; }else{ $v72="checked"; }
											?>
								...
								<table width="100%">
									<tr>
										...
										<td width="25%" align="right"> 
											Kiri <input type="text" name="1011" style="width:50px" value="<?=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'1011')?>" readonly="true" > cd <br>
											Kanan <input type="text" name="1012" style="width:50px" value="<?=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'1012')?>" readonly="true" > cd&nbsp;
										</td>
										<td width="17%" rowspan="3" align="center">
											<?php
												$penguji4=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'1011','penguji');
											?>
											<select name="penguji_10" disabled>
											<option value="">Pilih Penguji</option>
											<?php foreach($penguji as $p): ?> 
											<?php if($penguji4==$p->NRP){ $p4="selected"; }else{ $p4=""; } ?>
												<option value="<?=$p->nip_penguji?>" <?=$p4?> ><?=$p->nama_penguji?></option>
											<?php endforeach; ?>
											</select>
										</td>
									...
									<tr>
										...
										<td align="right"> <input type="text" name="1021" style="width:50px" value="<?=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'1021')?>" readonly="true" > &deg; &nbsp;&nbsp; 
					 <input type="text" name="1022" style="width:50px" value="<?=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'1022')?>" readonly="true" > &acute; </td>
									</tr>
									<tr>
										<td>c.</td>
										<td>Sudut Deviasi Kiri</td>
										<td align="center"><small><b><i> 0&deg; 34&acute; (max)  1&deg; 09&acute; (min)</i></b></small></td>
										<td align="right"> <input type="text" name="1031" style="width:50px" value="<?=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'1031')?>" readonly="true" > &deg; &nbsp;&nbsp;&nbsp;
					 <input type="text" name="1032" style="width:50px" value="<?=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'1032')?>" readonly="true" > &acute; </td>
									</tr>
								</table>
								</div>
								</fieldset>
								...
								<table width="100%">
									<tr>
										...
										<td align="right" width="25%"><input type="text" name="1111" style="width:50px" value="<?=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'1111')?>" readonly="true" > mm / meter &nbsp;</td>
										<td width="17%" align="center">
											<?php
												$penguji5=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'1111','penguji');
											?>
											<select name="penguji_11" disabled>
											<option value="">Pilih Penguji</option>
											<?php foreach($penguji as $p): ?> 
											<?php if($penguji5==$p->NRP){ $p5="selected"; }else{ $p5=""; } ?>
												<option value="<?=$p->nip_penguji?>" <?=$p5?> ><?=$p->nama_penguji?></option>
											<?php endforeach; ?>
											</select>
										</td>
								...
								<table width="100%">
									<tr>
										...
										<td align="right" width="25%"><input type="text" name="1211" style="width:50px" value="<?=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'1211')?>" readonly="true" > KG &nbsp;</td>
										<td width="17%" align="center">
											<?php
												$penguji6=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'1211','penguji');
											?>
											<select name="penguji_12" disabled>
											<option value="">Pilih Penguji</option>
											<?php foreach($penguji as $p): ?> 
											<?php if($penguji6==$p->NRP){ $p6="selected"; }else{ $p6=""; } ?>
												<option value="<?=$p->nip_penguji?>" <?=$p6?> ><?=$p->nama_penguji?></option>
											<?php endforeach; ?>
											</select>
										</td>
								...
								<table width="100%">
									<tr>
										...
										<td width="25%" align="right">S1 = <input type="text" name="1311" style="width:50px" value="<?=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'1311')?>" readonly="true" > %</td>
										<td rowspan="9" width="17%" align="center">
											<?php
												$penguji7=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'1311','penguji');
											?>
											<select name="penguji_13" disabled>
											<option value="">Pilih Penguji</option>
											<?php foreach($penguji as $p): ?> 
											<?php if($penguji7==$p->NRP){ $p7="selected"; }else{ $p7=""; } ?>
									...
									<tr align="right">
										<td>S2 = <input type="text" name="1312" style="width:50px" value="<?=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'1312')?>" readonly="true" > %</td>
									</tr>
									<tr align="right">
										<td>S3 = <input type="text" name="1313" style="width:50px" value="<?=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'1313')?>" readonly="true" > %</td>
									</tr>
									<tr align="right">
										<td>S4 = <input type="text" name="1314" style="width:50px" value="<?=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'1314')?>" readonly="true" > %</td>
									</tr>
									<tr>
										<td rowspan="4">b.</td>
										...
										<td align="right">S1 = <input type="text" name="1321" style="width:50px" value="<?=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'1321')?>" readonly="true" > %</td>
									</tr>
									<tr align="right">
										<td>S2 = <input type="text" name="1322" style="width:50px" value="<?=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'1322')?>" readonly="true" > %</td>
									</tr>
									<tr align="right">
										<td>S3 = <input type="text" name="1323" style="width:50px" value="<?=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'1323')?>" readonly="true" > %</td>
									</tr>
									<tr align="right">
										<td>S4 = <input type="text" name="1324" style="width:50px" value="<?=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'1324')?>" readonly="true" > %</td>
									</tr>
									<tr>
										<td>c.</td>
										<td>Efisiensi Rem Parkir (Hpb)</td>
										<td align="center"><small><b><i>Mbl. Penumpang Min 12 %, <br> Mbl. Barang Min 16 %</i></b></small></td>
										<td align="right"><input type="text" name="1331" style="width:50px" value="<?=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'1331')?>" readonly="true" > %</td>
									</tr>
								</table>
								</div>
								</fieldset>
								...
								<table width="100%">
									<tr>
										...
										<td width="25%" align="right"><input type="text" name="1411" style="width:100px" value="<?=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'1411')?>" readonly="true" > km/j</td>
										<td width="17%" align="center">
											<?php
												$penguji8=$this->prapengujianmodel->getHasilUjiFisik($no_daftar,'1411','penguji');
											?>
											<select name="penguji_14" disabled>
											<option value="">Pilih Penguji</option>
											<?php foreach($penguji as $p): ?> 
											<?php if($penguji8==$p->NRP){ $p8="selected"; }else{ $p8=""; } ?>
                 		...
                 		<div style="min-height:255px">
							<div >
								...
								<?php foreach($hasildata as $dat)
								{
									...
									$verifikasi2= $dat->hasil_pengujian;
									$ket		= $dat->keterangan;
								}
								?>
								...
								<table width="100%">
									...
									<tr>
										...
										<td> 
											<?php 
												if($verifikasi2=="Lulus"){ $s1="selected"; }elseif($verifikasi2=="tidak lulus"){ $s2=="selected"; }
											?>
