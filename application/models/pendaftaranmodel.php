...
class pendaftaranmodel extends CI_Model
{
	...
	function getAllSudahPraUji() 
  	{
  		$query = $this->db->query("SELECT * FROM pendaftaran a, kendaraan b 
										WHERE a.no_srut = b.no_srut AND a.status = 'pra-uji' ORDER BY tgl_pendaftaran DESC");
		return $query->result();
  	}
