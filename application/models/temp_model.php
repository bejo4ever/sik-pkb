...
';
	...
	function submenuPraUji($id,$idData)
	{
		switch($id)
		{
			case"1"; $sm1='class="current"'; break;
		...
		$data='<nav class="collapsed">';
			$data.='<a class="chevron" href="#">&raquo;</a>';
			$data.='<ul>';
				$data.='<li '.$sm1.' ><a href="'.base_url().'index.php/prapengujian/detail/'.$idData.'" class="navicon-table">Detail Kendaraan</a></li>';
				#$data.='<li '.$sm2.' ><a href="'.base_url().'index.php/prapengujian/uraian/'.$idData.'" class="navicon-table">Uraian Kendaraan</a></li>';
				$data.='<li '.$sm3.' ><a href="'.base_url().'index.php/prapengujian/ujifisik/'.$idData.'" class="navicon-table">Uji Fisik</a></li>';
				$data.='<li '.$sm4.' ><a href="'.base_url().'index.php/prapengujian/ujimekanis/'.$idData.'" class="navicon-table">Uji Mekanis</a></li>';
			$data.='</ul>';
		$data.='</nav>';
