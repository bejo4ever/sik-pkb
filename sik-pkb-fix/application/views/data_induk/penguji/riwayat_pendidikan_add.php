...
<body style="overflow: hidden;">
          ...
          <form class="form has-validation" id="formAdd" action="<?=base_url()?>index.php/penguji/riwayat_save" method="post">
			...
			<div class="form-input">
			<input type="text" style="width:190px" id="periode" name="periode" required="required" />
			</div>
			...
			<div class="form-action clearfix" align="right" style="padding-right:10px">
					...
					<button class="button" type="button" onClick="$('#addRiwayat' ).dialog('close');">Batalkan</button>
				</div>
		</form>
