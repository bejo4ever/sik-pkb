			...
			<section class="main-section grid_8">
				...
				<div class="main-content" style="min-height:255px">
					...
					<section class="container_6 clearfix" style="margin-top:-30px;">
						...
						<form class="form has-validation" action="<?=base_url()?>index.php/prapengujian/simpanUraian" method="post">
										...
										<tr>
											...
											<td>
												...
												<tr>
													...
													<td>
													<select name="da6">
														<option value="1" <?php echo ($da6==1?'selected':'') ?>>1</option>
														<option value="2" <?php echo ($da6==2?'selected':'') ?>>2</option>
														<option value="3" <?php echo ($da6==3?'selected':'') ?>>3</option>
														<option value="4" <?php echo ($da6==4?'selected':'') ?>>Khusus</option>
													</select>
													</td>
												</tr>
												</table>
