<page backtop="60px" backbottom="15px" backleft="5px" backright="5px" width="100%">
	...
	<h3 align="center">
		Rekapitulasi Jumlah Kendaraan Wajib Uji s.d. Bulan <?=$this->converter_model->getNamaBulan(date('m'))?> <?=date('Y')?> <br> Jenis Kendaraan: <?=$kelompok?>
	</h3>
	...
	<table border="1" align="center" cellpadding="0" cellspacing="0">
		...
		<tr align="center">
			...
			<th class="ui-state-default" rowspan="2" width="200"><b>Subjenis Kendaraan</b></th>
