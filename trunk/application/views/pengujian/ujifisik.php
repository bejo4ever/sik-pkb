			...
			<section class="main-section grid_8">
				...
				<div class="main-content" style="min-height:255px">
					...
					<section class="container_6 clearfix" style="margin-top:-30px;">
						...
						<form class="form has-validation" action="<?=base_url()?>index.php/pengujian/simpanUjifisik" method="post">
							<?php $tData=count($this->pengujianmodel->getHasilUjiFisik($no_BAP,'111','hasil')); ?>
							...
							<div class="clearfix">
								<table width="100%">
									<tr>
										...
										<?php
											$h1=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'111','hasil');
										...
										<?php
											$penguji1=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'112','penguji');
										?>
									...
									<tr>
										...
										<td align="center">
										<?php
											$h2=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'112','hasil');
							...
							<div class="clearfix">
								<table width="100%">
									<tr>
										...
										<td width="25%" align="center">
										<?php
											$h3=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'211','hasil');
										...
										<?php
											$penguji2=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'211','penguji');
										?>
									...
									<tr>
										...
										<td align="center">
										<?php
											$h4=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'212','hasil');
									...
									<tr>
										...
										<td align="center">
										<?php
											$h5=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'213','hasil');
									...
									<tr>
										...
										<td align="center">
										<?php
											$h6=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'214','hasil');
							...
							<div class="clearfix">
								<table width="100%">
									<tr>
										...
										<td width="25%" align="center">
										<?php
											$h7=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'311','hasil');
										...
										<?php
											$penguji3=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'311','penguji');
										?>
									...
									<tr>
										...
										<td align="center">
										<?php
											$h8=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'312','hasil');
									...
									<tr>
										...
										<td align="center">
										<?php
											$h9=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'313','hasil');
							...
							<div class="clearfix">
								<table width="100%">
									<tr>
										...
										<td width="25%" align="center">
										<?php
											$h10=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'411','hasil');
										...
										<?php
											$penguji4=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'411','penguji');
										?>  
									...
									<tr>
										...
										<td align="center">
										<?php
											$h11=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'412','hasil');
									...
									<tr>
										...
										<td align="center">
										<?php
											$h12=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'413','hasil');
									...
									<tr>
										...
										<td align="center">
										<?php
											$h13=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'414','hasil');
									...
									<tr>
										...
										<td align="center">
										<?php
											$h14=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'415','hasil');
									...
									<tr>
										...
										<td align="center">
										<?php
											$h15=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'416','hasil');
							...
							<div class="clearfix">
								<table width="100%">
									...
									<tr>
										...
										<td width="25%" align="center">
										<?php
											$h16=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'511','hasil');
										...
										<?php
											$penguji5=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'511','penguji');
										?>
									...
									<tr>
										...
										<td align="center">
										<?php
											$h17=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'512','hasil');
									...
									<tr>
										...
										<td align="center">
										<?php
											$h18=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'513','hasil');
									...
									<tr>
										...
										<td align="center">
										<?php
											$h19=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'514','hasil');
									...
									<tr>
										...
										<td align="center">
										<?php
											$h20=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'515','hasil');
									...
									<tr>
										...
										<td align="center">
										<?php
											$h21=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'521','hasil');
									...
									<tr>
										...
										<td align="center">
										<?php
											$h22=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'522','hasil');
									...
									<tr>
										...
										<td align="center">
										<?php
											$h23=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'523','hasil');
									...
									<tr>
										...
										<td align="center">
										<?php
											$h24=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'531','hasil');
									...
									<tr>
										...
										<td align="center">
										<?php
											$h25=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'532','hasil');
									...
									<tr>
										...
										<td align="center">
										<?php
											$h26=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'533','hasil');
									...
									<tr>
										...
										<td align="center">
										<?php
											$h27=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'541','hasil');
									...
									<tr>
										...
										<td align="center">
										<?php
											$h28=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'542','hasil');
									...
									<tr>
										...
										<td align="center">
										<?php
											$h29=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'543','hasil');
									...
									<tr>
										...
										<td align="center">
										<?php
											$h30=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'544','hasil');
									...
									<tr>
										...
										<td align="center">
										<?php
											$h31=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'545','hasil');
									...
									<tr>
										...
										<td align="center">
										<?php
											$h32=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'546','hasil');
							...
							<div class="clearfix">
								<table width="100%">
									<tr>
										...
										<td width="25%" align="center">
										<?php
											$h33=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'611','hasil');
										...
										<?php
											$penguji6=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'611','penguji');
										?>
									...
									<tr>
										...
										<td align="center">
										<?php
											$h34=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'612','hasil');
									...
									<tr>
										...
										<td align="center">
										<?php
											$h35=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'613','hasil');
									...
									<tr>
										...
										<td align="center">
										<?php
											$h36=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'614','hasil');
									...
									<tr>
										...
										<td align="center">
										<?php
											$h37=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'615','hasil');
									...
									<tr>
										...
										<td align="center">
										<?php
											$h38=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'616','hasil');
									...
									<tr>
										...
										<td align="center">
										<?php
											$h39=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'617','hasil');
									...
									<tr>
										...
										<td align="center">
										<?php
											$h40=$this->pengujianmodel->getHasilUjiFisik($no_BAP,'618','hasil');
