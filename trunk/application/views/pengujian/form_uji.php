    ...
    <div id="wrapper" class="clearfix">
        ...
        <section>
            ...
            <div class="container_8 clearfix">                
                ...
                <section class="main-section grid_8">
                    ...
                    <div class="main-content" style="min-height:255px">
                        <header>
                            <h2>Input Data Hasil Pengujian</h2>
                        </header>
			...
			<legend>Speedometer</legend>
				...
				<button type="button" onClick="location.href='<?=base_url()?>index.php/pengujian';" class="button" style="width:90px; height:30px"  data-icon-primary="ui-icon-circle-close">Cancel</button>
				</div>
