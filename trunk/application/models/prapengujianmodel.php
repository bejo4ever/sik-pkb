...
class prapengujianmodel extends CI_Model
{
	private $tbl	= 'detail_hasil_prapengujian';
	private $tbl2	= 'hasil_prapengujian';
	...
	{
		$query = $this->db->query("SELECT * FROM ".$this->tbl." WHERE no_bap = '$noBap' AND kd_itempengujian = '$kdItem' ");
		#echo "SELECT * FROM detail_hasil_prapengujian WHERE no_bap = '$noBap' AND kd_itempengujian = '$kdItem' ";
